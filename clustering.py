...
def plot_cluster_pair(S1, S2, labels_W, labels_H, \
                      cell_type_labels=None, dotsize=15, \
                      spacing=20, color_scheme='tab', \
                      title=None, save_name=None, flip=False):
    """
    Input

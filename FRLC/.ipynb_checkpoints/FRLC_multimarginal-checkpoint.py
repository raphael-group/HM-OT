...
def FRLC_LR_opt_multimarginal(C_factors_tm1t, A_factors_tm1t, B_factors_tm1t, \
                    C_factors_ttp1, A_factors_ttp1, B_factors_ttp1, tau_in = 0.0001, tau_out=75, \
    ...
    while (k < max_iter and (not convergence_criterion or \
        ...
        gradQ_t, gamma_k = compute_grad_A_multimarginal(C_factors_tm1t, A_factors_tm1t, B_factors_tm1t, Q_tm1, Q_t, Lambda_tm1t, \
                                 C_factors_ttp1, A_factors_ttp1, B_factors_ttp1, Q_tp1, Lambda_ttp1, \
                                    gamma, device=device, alpha=alpha, dtype=dtype, full_grad=full_grad)
        ...
        """
        gradT_tm1t, gamma_T = gd.compute_grad_B_LR(C_factors_tm1t, A_factors_tm1t, \
                                                     B_factors_tm1t, Q_tm1, Q_t, Lambda_tm1t, gQ_tm1, gQ_t, gamma, device, \
        ...
        """
        gradT_ttp1, gamma_T = gd.compute_grad_B_LR(C_factors_ttp1, A_factors_ttp1, \
                                                     B_factors_ttp1, Q_t, Q_tp1, Lambda_ttp1, gQ_t, gQ_tp1, gamma, device, \
                                                       alpha=alpha, dtype=dtype)
